...
* * *
This small draft tutorial shows how to utilize the new [CIP 33](https://cips.cardano.org/cips/cip33/) and  [CIP 32](https://cips.cardano.org/cips/cip32/). We will use a basic plutusV2 script given by the validator
```
